	...
	public static void main(String[] args)
	{
		...
		while (val_jogo)
		{
			...
			for (int i = 0; i < max_shot; i++)
			{
				...
				if (i < max_shot)
				{
					val_jogo = abandonarJogo(val_jogo, scan);
					if (val_jogo == false)
					{
		...
		System.out.println(jogadasTotal);

		System.out.print("Menu Principal");

	}

	private static boolean abandonarJogo(boolean val_jogo, Scanner scan)
	{
		...
		while (val_escolha)
		{
			System.out.println("Insira [1] para continuar a jogar e [2] para abandonar a partida.");
			i = scan.nextInt();
